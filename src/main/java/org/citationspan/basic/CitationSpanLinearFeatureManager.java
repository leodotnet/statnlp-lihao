...
public class CitationSpanLinearFeatureManager extends CitationSpanFeatureManager {

	public CitationSpanLinearFeatureManager(GlobalNetworkParam param_g) {
		super(param_g);
	}

	public CitationSpanLinearFeatureManager(GlobalNetworkParam param_g, String neuralType, boolean moreBinaryFeatures) {
	...
	protected FeatureArray extract_helper(Network network, int parent_k, int[] children_k, int children_k_index) {
		...
		if (nodetype_parent == NodeType.Root.ordinal()) {
			...
			String w = Utils.getToken(inputs, pos_parent, CitationSpanInstance.FEATURE_TYPES.word.ordinal());
			String lw = Utils.getToken(inputs, pos_parent - 1, CitationSpanInstance.FEATURE_TYPES.word.ordinal());
			String llw = Utils.getToken(inputs, pos_parent - 2, CitationSpanInstance.FEATURE_TYPES.word.ordinal());
			String rw = Utils.getToken(inputs, pos_parent + 1, CitationSpanInstance.FEATURE_TYPES.word.ordinal());
			String rrw = Utils.getToken(inputs, pos_parent + 2, CitationSpanInstance.FEATURE_TYPES.word.ordinal());
			
			word =  Utils.getToken(inputs, pos_parent, CitationSpanInstance.FEATURE_TYPES.word.ordinal());
			...
			if (CitationSpanGlobal.ENABLE_DISCRETE_FEATURE) {
				...
				if (!CitationSpanGlobal.SYNTAX_FEATURE) {
					featureCandicate = new int[]{3, 4, 5};
				}
				
				/*
				for(int i = CitationSpanInstance.FEATURE_TYPES.lemma.ordinal(); i <= CitationSpanInstance.FEATURE_TYPES.pos_tag.ordinal(); i++) {
...
//				}
				...
				//for(int i = CitationSpanInstance.FEATURE_TYPES.word.ordinal(); i <= CitationSpanInstance.FEATURE_TYPES.syntax.ordinal(); i++) 
				...
				featureList.add(this._param_g.toFeature(network, FeaType.tag + "", t + "=>" + nt, "curr_lemma:" + Utils.getToken(inputs, pos_parent, CitationSpanInstance.FEATURE_TYPES.lemma.ordinal())));
				featureList.add(this._param_g.toFeature(network, FeaType.tag + "", t + "=>" + nt, "next_lemma:" + Utils.getToken(inputs, pos_parent + 1, CitationSpanInstance.FEATURE_TYPES.lemma.ordinal())));
				
				featureList.add(this._param_g.toFeature(network, FeaType.tag + "", t + "=>" + nt, "curr_pos_tag:" + Utils.getToken(inputs, pos_parent, CitationSpanInstance.FEATURE_TYPES.lemma.ordinal())));
				featureList.add(this._param_g.toFeature(network, FeaType.tag + "", t + "=>" + nt, "next_pos_tag:" + Utils.getToken(inputs, pos_parent + 1, CitationSpanInstance.FEATURE_TYPES.lemma.ordinal())));
				*/
