...
public class Ace05LRMain {
	...
	public static String resultFile = "experiments/ace2005_res.txt";
	...
	public static boolean readPreLabels = false;
	public static String preLabelsFile = "data/ace2005/prevlabels.txt";
	...
	//public static boolean useHeadSpan = false;
...
//	public static String gloveEmbeddingFile = "nn-crf-interface/neural_server/google/gloveExample.txt";
	...
	public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException {
		...
		Ace05DataReader reader = new Ace05DataReader();
...
//		System.exit(0);
		...
		if (readModel) {
			...
			Ace05LRFeatureManager tfm = new Ace05LRFeatureManager(gnp, useRelDiscreteFeatures, useGeneralTags, 
...
//			}
			model.train(trainData, numIteration, devData, evalFunction, evalK);
		}
		if (saveModel) {
	...
	private static void setArgs(String[] args) {
		...
		parser.addArgument("-headspan", "--headspan").type(Boolean.class).setDefault(Span.HEAD_AS_SPAN).help("specify the if to use head span");
...
//		parser.addArgument("--fixFeatWeights").type(Boolean.class).setDefault(NetworkConfig.FIX_FEATURE_WEIGHT).help("fix the feature weights");
        ...
        Span.HEAD_AS_SPAN = ns.getBoolean("headspan");
