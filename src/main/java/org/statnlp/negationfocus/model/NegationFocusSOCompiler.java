...
public class NegationFocusSOCompiler extends NegationCompiler {
	...
	public NegationFocusSOCompiler() {
		super();
	}
	...
	public Label[] getLabels() {
		String[] labelForms = new String[] { "OB", "OA", "OM", "OR", "IR" };
