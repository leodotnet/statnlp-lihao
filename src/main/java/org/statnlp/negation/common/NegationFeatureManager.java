package org.statnlp.negation.common;
...
public abstract class NegationFeatureManager extends FeatureManager {
	...
	public FeatureArray getNeuralFeature(Network network, int parent_k, int[] children_k, int children_k_index, NegationInstance inst, int tagId, String tagStr, int leftBoundary, int rightRoundary, String sentence ) {
