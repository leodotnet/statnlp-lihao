...
public class NegationScopeSemiCompactNViewer extends VisualizationViewerEngine {
	...
	public NegationScopeSemiCompactNViewer(Map<Integer, Label> labels){
		super(null);
		this.labels = labels;
	}
	
	
	public NegationScopeSemiCompactNViewer(InstanceParser instanceParser) {
