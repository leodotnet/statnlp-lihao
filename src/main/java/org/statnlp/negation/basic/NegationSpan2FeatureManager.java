...
public class NegationSpan2FeatureManager extends NegationFeatureManager {

	public NegationSpan2FeatureManager(GlobalNetworkParam param_g) {
		super(param_g);
	}

	public NegationSpan2FeatureManager(GlobalNetworkParam param_g, String neuralType, boolean moreBinaryFeatures) {
