...
public class NegationScopeJointNCompiler4 extends NegationScopeJointCompiler {
	...
	public NegationScopeJointNCompiler4() {
		super();
	}
	...
	public Label[] getLabels() {
		String[] labelForms = new String[] { "O-Cue", "B-Cue", "O-Scope", "I-Scope", "ON-Scope", "IN-Scope" };
