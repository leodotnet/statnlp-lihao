...
public class NegationScopeSemiCompact5Viewer extends VisualizationViewerEngine {
	...
	public NegationScopeSemiCompact5Viewer(Map<Integer, Label> labels){
		super(null);
		this.labels = labels;
	}
	
	
	public NegationScopeSemiCompact5Viewer(InstanceParser instanceParser) {
