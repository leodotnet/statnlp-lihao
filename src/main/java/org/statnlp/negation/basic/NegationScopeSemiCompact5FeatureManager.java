...
import org.statnlp.negation.basic.NegationScopeSemiCompact5Compiler.*;

public class NegationScopeSemiCompact5FeatureManager extends NegationFeatureManager {

	public NegationScopeSemiCompact5FeatureManager(GlobalNetworkParam param_g) {
		super(param_g);
	}

	public NegationScopeSemiCompact5FeatureManager(GlobalNetworkParam param_g, String neuralType, boolean moreBinaryFeatures) {
