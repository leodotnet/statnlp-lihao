...
public class NegationScopeSemiCompactNFeatureManager extends NegationFeatureManager {

	public NegationScopeSemiCompactNFeatureManager(GlobalNetworkParam param_g) {
		super(param_g);
	}

	public NegationScopeSemiCompactNFeatureManager(GlobalNetworkParam param_g, String neuralType, boolean moreBinaryFeatures) {
