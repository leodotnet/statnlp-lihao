...
public class NegationScopeSemiCompactNCompiler extends NegationCompiler {
	...
	public NegationScopeSemiCompactNCompiler() {
		super();
		NetworkIDMapper.setCapacity(new int[] { NegationGlobal.MAX_SENTENCE_LENGTH, 1, 200, myNodeTypeSize});
	}
