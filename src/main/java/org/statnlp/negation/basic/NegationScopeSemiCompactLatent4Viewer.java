...
public class NegationScopeSemiCompactLatent4Viewer extends VisualizationViewerEngine {
	...
	public NegationScopeSemiCompactLatent4Viewer(Map<Integer, Label> labels){
		super(null);
		this.labels = labels;
	}
	
	
	public NegationScopeSemiCompactLatent4Viewer(InstanceParser instanceParser) {
	...
	protected void initNodeCoordinate(VisualizeGraph vg)
	{
		for(VNode node : vg.getNodes())
		{
			...
			double y = mappedId * span_height + offset_height - 30 + 10 * latentIdx;
