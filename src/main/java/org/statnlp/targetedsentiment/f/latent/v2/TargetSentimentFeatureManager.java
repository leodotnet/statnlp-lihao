package org.statnlp.targetedsentiment.f.latent.v2;
...
public class TargetSentimentFeatureManager extends FeatureManager {
	...
	protected FeatureArray extract_helper(Network network, int parent_k, int[] children_k, int children_k_index) {
				...
				|| (subnode_child == SubNodeType.e.ordinal()))
		{
			...
			{
				Out = (subnode_parent == SubNodeType.B.ordinal() ? "B-" : "I-") + PolarityType.values()[polar_parent].name();
				eId = polar_parent + 1;
			}
		...
		String curr_word = word_parent.toLowerCase();
		String next_word = next_feature.toLowerCase();
		String prev_word = prev_feature.toLowerCase();
		...
		if (subnode_parent == SubNodeType.B.ordinal() && subnode_child == SubNodeType.e.ordinal())
		{
			...
			String postition = "<Middle>";
			if (pos_parent < 2) {
				postition = "<START>";
			} 
			
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_Start" , postition , "position:"));
			
			
			
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_Start" , PolarityType.values()[polar_parent].name() , "current_word:" + curr_word + "|||" + next_brown_cluster));
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_Start" , PolarityType.values()[polar_parent].name() , "current_word:" +  curr_word + "-jerboa:" +  current_jerboa));
			
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_Start" , PolarityType.values()[polar_parent].name() ,"current_word:" +  curr_word));
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_Start" , PolarityType.values()[polar_parent].name() ,  "last_word:" + prev_word + "|||" + "current_word:" + curr_word));
			

			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_Start" , PolarityType.values()[polar_parent].name() , "current_word:" + curr_word + "next_word:" +  next_word));
			
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_Start" , PolarityType.values()[polar_parent].name() ,  "last_word:" + prev_word + "|||" + "current_word:" + curr_word + "next_word:" +  next_word));
			...
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_Start" , PolarityType.values()[polar_parent].name() , "current_word:" + curr_word + "first_letter_upper:" +  Character.isUpperCase(word_parent.charAt(0))));
			...
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_contains" , PolarityType.values()[polar_parent].name() , "current_word:" + curr_word ));		
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_contains" , PolarityType.values()[polar_parent].name() ,  "last_word:" + prev_word + "|||" + "current_word:" +  curr_word + "|||" + "next_word:" +  next_word));
			
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_contains" , PolarityType.values()[polar_parent].name() , "current_word:" + curr_word + "first_letter_upper:" +  Character.isUpperCase(word_parent.charAt(0))));
			...
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_Continue" , PolarityType.values()[polar_parent].name() , "current_word:" + curr_word));
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_Continue" , PolarityType.values()[polar_parent].name() , "current_word:" + curr_word + "|||" + "next_word:" + next_word));
			...
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Bigram + "-" + "NE_contains" , "", "current_word:" +word_parent + "|||" + "next_word:" + next_word ));
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Bigram + "-" + "NE_contains" , PolarityType.values()[polar_parent].name() ,"current_word:" + curr_word + "|||" + "next_word:" + next_word ));
			...
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_End" , PolarityType.values()[polar_parent].name() , "current_word:" + curr_word ));
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_End" , PolarityType.values()[polar_parent].name() , "current_word:" + curr_word + "|||" + "next_word:" + next_word));
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_End" , PolarityType.values()[polar_parent].name(), "last_word:" + prev_word +"|||" + "current_word:" + curr_word ));
			
			
			
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_contains" , "", word_parent ));
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_contains" , PolarityType.values()[polar_parent].name() , "current_word:" +curr_word ));
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_contains" , PolarityType.values()[polar_parent].name() , "current_word:" +curr_word + "|||" + "next_word:" + next_word));
			...
			String postition = "<Middle>";
			if (pos_parent >= size - 2) {
				postition = "<END>";
			} 
			
			feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "NE_End" , postition , "position:"));
		...
		if (subnode_parent == SubNodeType.B.ordinal() && subnode_child == SubNodeType.B.ordinal())
		{
			if (!TargetSentimentGlobal.WITHOUT_HIDDEN_SENTIMENT)
			{
				...
				feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "O_hidden_sentiment" , PolarityType.values()[polar_parent].name()+"_Before", "current_word:" +curr_word ));
				feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "O_hidden_sentiment" , PolarityType.values()[polar_parent].name(), "current_word:" +curr_word ));
		...
		else if (subnode_parent == SubNodeType.A.ordinal() && subnode_child == SubNodeType.A.ordinal())
		{
			if (!TargetSentimentGlobal.WITHOUT_HIDDEN_SENTIMENT)
			{
				...
				feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "O_hidden_sentiment" , PolarityType.values()[polar_parent].name()+"_After","current_word:" + curr_word  ));
				feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "O_hidden_sentiment" , PolarityType.values()[polar_parent].name(),"current_word:" + curr_word  ));
				//feature.add(this._param_g.toFeature(network, FEATURE_TYPES.Unigram + "-" + "O_hidden_sentiment" , PolarityType.values()[polar_parent].name(),   "current_word:" +word_parent + "|||" +  "next_word:" + next_feature ));
