...
public class SpanModelCompiler extends SpanModelSuperCompiler {
	...
	public enum OPNodeType {
		Magnify_neg, Medium_neg, Neg_neg, Medium_neu, Magnify_pos, Medium_pos, Neg_pos, LastNeg_4, LastNeg_3, LastNeg_2, LastNeg_1, LastPos_1, LastPos_2, LastPos_3, LastPos_4
	};*/
				...
				if (pos < size - 1)
					for (Integer j : sentimentStateCandidate) {
						...
						for (int k = 0; k < NormalOPNodeTypeSize; k++) {
							...
							if (toNextSentimentState >= SentimentStateTypeSize + 1 || toNextSentimentState < -1)
								continue;
