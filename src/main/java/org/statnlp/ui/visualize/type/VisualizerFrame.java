...
public class VisualizerFrame extends JFrame{
	...
	public static int INSTANCE_INIT_ID = 1;
	...
	private void init(){
		...
		JCheckBoxMenuItem hideSink = new JCheckBoxMenuItem("Hide Sink", VisualizeGraph.hideEdgetoSink);
		hideSink.addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent e) {
				VisualizeGraph.hideEdgetoSink = hideSink.isSelected();
				refresh();
			}
		});
