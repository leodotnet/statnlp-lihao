...
public class AbbrMetric implements Metric {
	...
	public AbbrMetric(boolean aggregation) {
	...
	public void aggregate(AbbrMetric metric) {
	...
	public boolean isBetter(Metric other) {
		AbbrMetric metric = (AbbrMetric)other;
