...
public class EntityRelationLinearCompiler extends EntityRelationCompiler {
	...
	public EntityRelationLinearCompiler() {
		super();
	}
...
//				}
				...
				for(Entity entity1 : entities1) {
					for(Entity entity2 : entities2) {
						...
						if (relation.isSelfRelation() || relation.isNORelation())
							continue;
