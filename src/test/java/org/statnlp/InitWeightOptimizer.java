...
public class InitWeightOptimizer implements Optimizer {
	...
	/* (non-Javadoc)
	 * @see org.statnlp.commons.ml.opt.Optimizer#setObjective(double)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.statnlp.commons.ml.opt.Optimizer#setVariables(double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.statnlp.commons.ml.opt.Optimizer#setGradients(double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.statnlp.commons.ml.opt.Optimizer#getObjective()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.statnlp.commons.ml.opt.Optimizer#getVariables()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.statnlp.commons.ml.opt.Optimizer#getGradients()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.statnlp.commons.ml.opt.Optimizer#optimize()
	 */
	@Override
