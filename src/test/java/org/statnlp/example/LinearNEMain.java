...
public class LinearNEMain {
	...
	public static String trainFile = "data/Twitter_en/train.1.coll"; //"data/conll2003/eng.train";
...
//			gnp =  new GlobalNetworkParam(OptimizerFactory.getGradientDescentFactory());
			if (neuralType.equals("lstm")) {
				...
				String optimizer = nnOptimizer;
				boolean bidirection = true;
				nets.add(new BiLSTMCharWord(hiddenSize, 25, bidirection, optimizer, 0.05, 5, labels.length - 2, gpuId, embedding));
			}  
		...
		if(args[0].equals("-h") || args[0].equals("help") || args[0].equals("-help") ){
			...
			for(int i=0;i<args.length;i=i+2){
				switch(args[i]){
					...
					case "-neural": if(args[i+1].equals("mlp") || args[i+1].startsWith("lstm")|| args[i+1].equals("continuous")){ 
