...
public class MentionHypergraphDemo {
	...
	public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
		...
		boolean readModelIfAvailable = true;

		labels = new ArrayList<Label>();
		
		
		ObjectInputStream ois_label = new ObjectInputStream(new FileInputStream("LABELS"));
		Label.LABELS = (Map<String, Label>)ois_label.readObject();
		Label.LABELS_INDEX = (Map<Integer, Label>)ois_label.readObject();
		...
		String modelPath = args[0];//"mentionHypergraph.model";
		...
		String test_filename = args[1];// "data/ACE2005demo/train.data";
